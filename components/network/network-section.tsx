...
export function NetworkSection() {
  return (
    <section id="network-detail" className="relative py-24 sm:py-32 bg-[#0B1120]">
      {/* Background effects */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_#0D4F54_0%,_transparent_50%)] opacity-20" />
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_right,_#1A9D5C_0%,_transparent_50%)] opacity-10" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="inline-flex items-center gap-2 bg-[#162035] border border-[#ffffff10] rounded-full px-4 py-1.5 text-sm font-medium text-[#635BFF] mb-4">
        ...
        <motion.div
          ...
          className="bg-[#162035] border border-[#ffffff10] rounded-2xl p-4 sm:p-6 mb-8"
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-semibold text-[#F1FAEE]">Pilot Site Locations</h3>
              <p className="text-sm text-[#8B9CB6]">Interactive 3D visualization of ocean farms</p>
            </div>
          </div>
          <InteractiveGlobe />
        </motion.div>

        {/* Tabbed Interface - Electric Blue for active tab */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        ...
        >
          <Tabs defaultValue="digital-twin" className="w-full">
            <TabsList className="w-full justify-start bg-[#162035] border border-[#ffffff10] p-1 mb-6 overflow-x-auto">
              <TabsTrigger
                value="digital-twin"
                className="data-[state=active]:bg-[#635BFF]/20 data-[state=active]:text-[#635BFF] gap-2 text-[#8B9CB6]"
              >
            ...
            <div className="bg-[#162035] border border-[#ffffff10] rounded-2xl p-4 sm:p-6 lg:p-8 min-h-[500px]">
